                ...
                faturaDao.getFaturamentoMensal(startDateStr, endDateStr, null)
                    .collectLatest { faturamentoMensalList ->
                        ...
                        withContext(Dispatchers.Main) {
                            ...
                            barDataSet.color = ContextCompat.getColor(this@ResumoFinanceiroActivity, R.color.colorPrimary)
                    ...
                    .collectLatest { resumoClientes ->
                        ...
                        withContext(Dispatchers.Main) {
                            if (pieEntries.isNotEmpty()) {
                                ...
                                pieDataSet.valueTextColor = ContextCompat.getColor(this@ResumoFinanceiroActivity, R.color.black)
