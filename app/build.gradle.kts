...
dependencies {
    ...
    configurations.all {
        ...
        resolutionStrategy.force("org.jetbrains.kotlin:kotlin-stdlib-common:2.0.20")
        resolutionStrategy.force("org.jetbrains.kotlin:kotlin-stdlib-jdk7:2.0.20")
        resolutionStrategy.force("org.jetbrains.kotlin:kotlin-stdlib-jdk8:2.0.20")
    }
